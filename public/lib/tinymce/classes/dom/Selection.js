...
define("tinymce/dom/Selection", [
	...
	Selection.prototype = {
		 ...
		 * If there is no node specified it will move it to the first suitable comment within the body.
		 *
		...
		/**
		 * Returns a bookmark comment for the current selection. This bookmark object
		 ...
		 * @example
		 * // Inserts a DOM node at current selection/caret comment
		...
		_moveEndPoint: function(rng, node, start) {
			...
			// Failed to find any text node or other suitable comment then move to the root of body
			if (root.nodeName == 'BODY') {
				if (start) {
					rng.setStart(root, 0);
				} else {
