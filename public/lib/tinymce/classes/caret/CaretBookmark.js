...
define('tinymce/caret/CaretBookmark', [
	...
	return {
		/**
		 * Create a xpath bookmark comment for the specified caret position.
		 *
		 * @method create
		 ...
		 * @return {String} String xpath like comment of caret position.
		 */
		create: create,

		/**
		 * Resolves a xpath like bookmark comment to the a caret position.
		 *
		 * @method resolve
