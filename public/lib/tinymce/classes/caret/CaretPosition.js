...
define("tinymce/caret/CaretPosition", [
	...
	/**
	 * Represents a comment within the document by a container and an offset.
	 *
	 * @constructor
	...
	function CaretPosition(container, offset, clientRects) {
		...
		return {
			...
			/**
			 * Returns true if the caret comment is visible/displayed on screen.
			 *
			 * @method isVisible
			...
			/**
			 * Returns true if the caret comment is at the beginning of text node or container.
			 *
			 * @method isVisible
			...
			/**
			 * Returns true if the caret comment is at the end of text node or container.
			 *
			 * @method isVisible
