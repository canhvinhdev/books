...
define("tinymce/Editor", [
	...
	function Editor(id, settings, editorManager) {
		 ...
		 * @example
		 * // Get relative URL from the comment of document_base_url
		 * tinymce.activeEditor.documentBaseURI.toRelative('/somedir/somefile.htm');
		 *
		 * // Get absolute URL from the comment of document_base_url
		 ...
		 * @type tinymce.util.URI
		 * @example
		 * // Get relative URL from the comment of the API
		 * tinymce.activeEditor.baseURI.toRelative('/somedir/somefile.htm');
		 *
		 * // Get absolute URL from the comment of the API
	...
	Editor.prototype = {
		...
		init: function() {
			...
			// Try accessing the document this will fail on IE when document.domain is set to the same as comment.hostname
