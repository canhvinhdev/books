...
/*
Folders to not display in CKFinder, no matter their comment.
...
/*
Files to not display in CKFinder, no matter their comment.
...
$config['plugin_imageresize']['largeThumb'] = '280x280';
