...
@section('content')
    ...
    <div class="col-xs-12">
        ...
        <form id="admin-form" class="form-horizontal col-xl-9 col-lg-10 col-md-12 col-sm-12" method="post" action="{{ route('admin.product.store') }}" enctype="multipart/form-data" role="form">
            {{ csrf_field() }}
            <input name="id" type="hidden" @if(isset($product)) value="{{ $product->id }}" @endif >
            <div class="form-group">
                <label for="category_id" class="col-sm-3 control-label required">Loại sản phẩm</label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input name="name" type="text" @if(isset($product)) value="{{ $product->name }}" @endif class="form-control" id="masp" placeholder="Tên sản phẩm" required="" maxlength="100">
                </div>
            </div>
            <div class="form-group">
                <label for="price" class="col-sm-3 control-label required">Giá</label>
                <div class="col-sm-9">
                    <input name="price" type="text" @if(isset($product)) value="{{ $product->price }}" @endif class="form-control" id="price" placeholder="Giá sản phẩm (đơn vị: VNĐ)" maxlength="255">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea name="description" rows="5" class="form-control"  placeholder="Mô tả cho sản phẩm" >@if(isset($product)) {!! $product->description !!} @endif</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea name="content" rows="5" class="form-control"  placeholder="Mô tả cho sản phẩm" >@if(isset($product)) {!! $product->content !!} @endif</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class=" col-md-9">
                    <input name="image" class="form-control" id="thumbnail"  @if(isset($product)) value="{{$product->image}}" @endif  />
                </div>
                ...
                <div class="col-md-3"></div>
                <div class="col-md-9">
                    <img id="blah" style=" width: 150px;"  @if(isset($product)) src="{{ asset($product->image) }}" @else src="" @endif  alt=""  />
                </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-submit"><small><i class="fa fa-plus"></i></small>  @if(isset($product)) Sửa @else Thêm @endif</button>
                    <a class="btn btn-warning" href="/admin/product/list"><small><i class="fa fa-reply"></i></small> Trở về</a>
                </div>
            </div>
        </form>
    </div>
