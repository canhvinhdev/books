    ...
    <div class="col-xs-12">
        <form id="category-form" class="form-horizontal col-xl-8 col-lg-9 col-md-10" method="post" action="{{ route('admin.promotion.store') }}" >
          ...
          <!--   <div class="form-group">
                ...
                <label  class="col-sm-3 control-label required">Giá khuyến mãi </label>
                <div class="col-sm-9">
                    <input name="price" rows="5" class="form-control"  @if(isset($promotion)) value="{{ $promotion->name }}" @endif placeholder="Giá khuyến mãi" >
                </div>
            </div>
 -->

            <div class="form-group">
                <label  class="col-sm-3 control-label required">Nội dung khuyến mãi</label>
                <div class="col-sm-9">

                <textarea name="" id="" class="form-control finder" cols="30" rows="10"></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input name="start_day" type="date" @if(isset($promotion)) value="{{ $promotion->start_day }}" @endif class="form-control"  placeholder="Ngày bắt đầu" required="">
                </div>
            </div>
            <div class="form-group">
