...
@section('content')
    ...
    <div class="col-xs-12">
        <strong>Chi tiết đơn hàng</strong> <span class="hidden-xs">({{ $order->code }})</span><br><small><i class="fa fa-calendar"></i> {{ $order->created_at }}</small>
        @if($order->status == 1)
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 40px">
            ...
            <form action="{!! route('admin.order.store') !!}" method="post">
                ...
                <a href="#" class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn xóa?');"><i class="fa fa-trash-o"></i> In hóa đơn</a>
