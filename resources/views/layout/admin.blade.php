    ...
    <ul class="nav navbar-nav navbar-right">
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="/admin/user/edit/2"><i class="fa fa-user"></i> Chỉnh sửa tài khoản</a></li>
      ...
      <ul id="menu" class="list-group">
        ...
        <li class="list-group-item">
          <a href="/admin/promotion/list">
            <i class="fa fa-fire"></i><span>Khuyến mãi</span>
          </a>
        </li>
        ...
        <li class="list-group-item">
          <a href="/admin/comment/list">
            <i class="fa fa-envelope-o"></i> <span>Bình luận</span>
          </a>
        </li>
