...
Route::group(['prefix' => 'admin','middleware'=>'Checklogin', 'as' => 'admin.'], function() {
    ...
    //Route(url) phần bình luân
    Route::group(['prefix' => 'comment', 'as' => 'comment.'], function() {
        Route::get('list', 'Admin\CommentController@index')
            ->name('list');

        Route::get('add', 'Admin\LocationController@add')
                ->name('add');
        Route::post('store', 'Admin\CommentController@store')
                ->name('store');
        Route::get('edit/{id?}', 'Admin\CommentController@edit')
                ->name('edit');
...
Route::get('/khach-hang/{id}',['as'=>'customer','uses'=>'App\OrdersController@customer']);
Route::get('/cap-nhat-thong-tin-khach-hang/{id}',['as'=>'editCustomer','uses'=>'App\OrdersController@editCustomer']);
...
Route::get('/chi-tiet-bai-viet/{id}-{slug}',['as'=>'new.detail','uses'=>'App\NewController@detail']);
...
Route::get('/lien-he', ['as' => 'contact', 'uses' => 'App\ProductController@contact']);
